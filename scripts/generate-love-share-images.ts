...
async function main() {
  ...
  const modes = ["solo", "pair"] as const;
  ...
  for (const mode of modes) {
    ...
    for (let score = 0; score <= 100; score++) {
      console.log(`Generating ${mode} love ${score}%...`);
      ...
      await page.goto(
        `http://localhost:3000/internal/og-preview/love/${score}?mode=${mode}`,
        {
  ...
  console.log("✅ All 202 Love share images generated");
}
